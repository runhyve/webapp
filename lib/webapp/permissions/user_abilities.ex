...
defimpl Canada.Can, for: User do
  ...
  def can?(%User{} = user, :delete, %SSHPublicKey{} = ssh_public_key), do: user.id == ssh_public_key.user_id
  def can?(%User{} = user, :edit, %SSHPublicKey{} = ssh_public_key), do: user.id == ssh_public_key.user_id
  def can?(%User{} = user, :show, %SSHPublicKey{} = ssh_public_key), do: user.id == ssh_public_key.user_id
