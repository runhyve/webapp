defmodule WebappWeb.NetworkControllerTest do
  ...
  #      conn = get(conn, Routes.admin_network_path(conn, :index))
  ...
  #      conn = get(conn, Routes.admin_network_path(conn, :new))
  ...
  #      conn = post(conn, Routes.admin_network_path(conn, :create), network: @create_attrs)
  #
  #      assert %{id: id} = redirected_params(conn)
  #      assert redirected_to(conn) == Routes.admin_network_path(conn, :show, id)
  #
  #      conn = get(conn, Routes.admin_network_path(conn, :show, id))
  #      assert html_response(conn, 200) =~ "Show Network"
  #    end
  #
  #    test "renders errors when data is invalid", %{conn: conn} do
  #      conn = post(conn, Routes.admin_network_path(conn, :create), network: @invalid_attrs)
  #      assert html_response(conn, 200) =~ "New Network"
  #    end
  #  end
  #
  ...
  #      conn = get(conn, Routes.admin_network_path(conn, :edit, network))
  ...
  #      conn = put(conn, Routes.admin_network_path(conn, :update, network), network: @update_attrs)
  #      assert redirected_to(conn) == Routes.admin_network_path(conn, :show, network)
  #
  #      conn = get(conn, Routes.admin_network_path(conn, :show, network))
  #      assert html_response(conn, 200) =~ "some updated name"
  #    end
  #
  #    test "renders errors when data is invalid", %{conn: conn, network: network} do
  #      conn = put(conn, Routes.admin_network_path(conn, :update, network), network: @invalid_attrs)
  #      assert html_response(conn, 200) =~ "Edit Network"
  #    end
  #  end
  #
  ...
  #      conn = delete(conn, Routes.admin_network_path(conn, :delete, network))
  #      assert redirected_to(conn) == Routes.admin_network_path(conn, :index)
  #
  #      assert_error_sent 404, fn ->
  #        get(conn, Routes.admin_network_path(conn, :show, network))
  #      end
  #    end
  #  end
