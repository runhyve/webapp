...
# Test dummy data
Webapp.Repo.insert!(%Webapp.Plans.Plan{name: "1C-512MB-30HDD", ram: 512, storage: 30, cpu: 1, price: 10})
Webapp.Repo.insert!(%Webapp.Plans.Plan{name: "1C-1024MB-50HDD", ram: 1024, storage: 50, cpu: 1, price: 20})
Webapp.Repo.insert!(%Webapp.Plans.Plan{name: "2C-2048MB-100HDD", ram: 2048, storage: 100, cpu: 2, price: 30})
...
Webapp.Repo.insert!(%Webapp.Distributions.Distribution{name: "Ubuntu", version: "18.04", loader: "grub", image: "https://cloud-images.ubuntu.com/bionic/current/bionic-server-cloudimg-amd64.img"})
